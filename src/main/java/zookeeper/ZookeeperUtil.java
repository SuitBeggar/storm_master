 ...
 * @description:
 * @Author:bella
 * @Date:2019/11/2722:20
 * @Version:
 **/
public class ZookeeperUtil {

    public static final Logger logger = LoggerFactory.getLogger(ZookeeperUtil.class);

    private ZooKeeper zookeeper;

    public ZookeeperUtil(Watcher watcher) {
        try {
            zookeeper=new ZooKeeper("master1:2181,slave1:2181,slave2:2181", 5000, watcher);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
